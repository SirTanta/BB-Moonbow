    ...
    <div className="mb-8">
      ...
      {type === 'url-list' && (
        <textarea
          ...
          rows={4}
          value={strVal}
          placeholder="Paste URLs here, one per line. Add a note after each one."
      ...
      {type === 'color-palette' && (
        <div>
          ...
          <textarea
            ...
            rows={3}
            value={strVal}
            placeholder='Paste hex codes or describe: "dusty rose, sage, cream, no bright blue"'
            style={{ resize: 'vertical' }}
            onChange={e => onChange(id, e.target.value)}
          />
        </div>
